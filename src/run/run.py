...
def run(_run, _config, _log):
    ...
    if args.use_tensorboard:
        ...
        # Store paths for cleanup in case of failure
        try:
            import sys
            main_module = sys.modules['__main__']
            if hasattr(main_module, 'cleanup_paths'):
                main_module.cleanup_paths['tb_path'] = tb_exp_direc
                main_module.cleanup_paths['model_path'] = tb_exp_direc
        except:
            pass
...
def run_sequential(args, logger):
    ...
    try:
        import sys
        main_module = sys.modules['__main__']
        if hasattr(main_module, 'training_completed'):
            main_module.training_completed = True
    except:
        pass
